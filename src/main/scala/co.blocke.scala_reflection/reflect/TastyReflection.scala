...
object TastyReflection: // extends NonCaseClassReflection:
  ...
  def reflectOnType(quotes: Quotes)(aType: quotes.reflect.TypeRepr, fullName: String, resolveTypeSyms: Boolean): RType[_] = 
        ...
        case named: dotty.tools.dotc.core.Types.NamedType => 
          ...
          classSymbol match {
            ...
            case cs => 
              ...
              RType.cache.getOrElse(className, reflectOnClass(quotes)(typeRef, RType.typeName(quotes)(typeRef), resolveTypeSyms))
          }
  ...
  def reflectOnClass(quotes: Quotes)(typeRef: quotes.reflect.TypeRef, fullName: String, resolveTypeSyms: Boolean, appliedTob: List[quotes.reflect.TypeRepr] =  Nil): RType[_] = 
    import quotes.reflect.*
  ...
  def reflectOnField(quotes: Quotes)(
    ...
    ScalaFieldInfo(index, valDef.name, fieldType, fieldAnnos)
