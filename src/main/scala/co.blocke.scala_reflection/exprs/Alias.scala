...
object Alias:
  ...
  def makeExpr[T](a: AliasRType[T])(using q:Quotes)(using Type[T]): Expr[RType[T]] = 
    ...
    val typeExpr = stripType(ExprMaster.makeExpr(a.unwrappedType)(using q)(using tt.asInstanceOf[Type[a.unwrappedType.T]]).asInstanceOf[Expr[RType[a.unwrappedType.T]]])
