...
* 2.0.13 - Data in LeftRight and Try refs indicating if there is a child that is Option
...
* 2.0.9 - Move to Scala 3.5.2 and support bounded wildcard type parameters for collections
