  ...
  test("sealed trait with case classes") {
    ...
    assertEquals(
      ...
      """co.blocke.scala_reflection.models.VehicleHolder:
        ...
        |         annotations -> Map(co.blocke.reflect.ClassAnno -> Map(name -> Zoom))
        |         fields ->
        |         children ->
